...
output_path = os.path.join(BASE_DIR, 'Images', 'Traffic_BiLSTM_optimal_top_ratio_plot.png')
...
if os.path.isfile(model_path):
    ...
    plt.title("Traffic BiLSTM Prediction Curves Under Standard and KTSA Attacks", size=16)
